#  show_light_text_three_lines is a method to show three lines of text centered on a given surface.
...
def show_light_text_three_lines(
    ...
    _text_object_3: pygame.Surface = font.render(text[2], True, colour)
    ...
    _text_rect_3: pygame.Rect = _text_object_3.get_rect(
        center=(
            _left + int(_width / 2) + x_offset,
            _top + int(_height / 2) + y_offset + _multiline_offset,
        )
    ...
    display.blit(_text_object_3, _text_rect_3)
